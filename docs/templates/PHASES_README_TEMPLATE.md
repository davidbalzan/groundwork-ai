...
- [README](README.md) — Phase overview, goals, deliverables, and success criteria (quick reference)
...
- **`Production Roadmap`** — High-level roadmap with current focus and success metrics
- **[Current Focus](CURRENT_FOCUS.md)** — What's actively being worked on right now
- **[Decisions Log](DECISIONS.md)** — ADRs that affect phase planning and architecture
